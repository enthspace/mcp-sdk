...
import type { StartSSEOptions, StreamableHTTPReconnectionOptions } from './streamableHttp.js';
...
import type { JSONRPCMessage, JSONRPCRequest } from '@enth/mcp-specs/draft';
...
describe('StreamableHTTPClientTransport', () => {
    ...
    let mockAuthProvider: OAuthClientProvider & {
        // This type trick makes only the function properties into mocks
        // Allowing the getters to remain their original types
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        [K in keyof OAuthClientProvider as OAuthClientProvider[K] extends (...args: any[]) => any ? K : never]: Mock;
    };
